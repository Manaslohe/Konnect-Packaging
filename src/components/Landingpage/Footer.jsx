...
const SectionTitle = ({ children }) => (
  <h3 className="text-[#E9C77F] text-xl font-bold mb-5 uppercase tracking-wider">{children}</h3>
);

const LightText = ({ children, className = "" }) => (
  <p className={`text-gray-300 text-sm mb-2 leading-relaxed ${className}`}>{children}</p>
);
          ...
          <div className="col-span-1 flex flex-col justify-center h-full md:h-[220px]">
            <div className="flex flex-col relative z-10 items-start">
              ...
              <div style={{ display: "none" }}>
                <h1 className="text-5xl font-bold text-[#E9C77F]">KONNECT</h1>
                <p className="text-xl mt-1 font-light text-white">packaging excellence;</p>
              </div>
            </div>
          </div>
          {/* Our Company Section */}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
            <div className="flex justify-center md:justify-start order-2 md:order-1">
              <span className="hover:text-[#E9C77F] transition-colors duration-300 text-[11px] pt-4 md:pt-0 text-gray-500">
