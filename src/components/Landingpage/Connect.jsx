  ...
  return (
    <div className="flex overflow-hidden flex-col py-8 px-4 bg-white md:py-12 md:pl-9 lg:pl-9 font-['Krona_One']">
      ...
      <div className="flex flex-col bg-gradient-to-r from-[#E7C375] to-[#fffffe] items-start pt-4 px-4 pb-12 mt-8 w-full rounded-[30px] md:pt-5 md:pr-20 md:pb-20 md:pl-9 md:mt-20 md:rounded-[50px] lg:px-9">
        ...
        <div className="mt-3 text-sm leading-relaxed font-normal text-black w-full md:text-base lg:text-lg md:pt-4 md:w-[710px] lg:w-[710px]">
        ...
        <div className="grid grid-cols-2 gap-3 self-center mt-8 w-full text-sm text-white md:flex md:flex-row md:flex-wrap md:gap-3 md:justify-between md:mt-12 md:text-base lg:mt-16 lg:gap-5 lg:max-w-[1155px]">
          <div className="flex items-center gap-1.5 px-6 py-2 whitespace-nowrap bg-black rounded-3xl justify-center md:px-8 md:py-2.5 cursor-pointer transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg">
            <FaWhatsapp className="w-[24px] h-[24px] md:w-[30px] md:h-[30px]" />
            <div className="basis-auto">WhatsApp</div>
          </div>
          <div className="flex items-center gap-1.5 px-6 py-2 bg-black rounded-3xl justify-center md:px-8 md:py-2.5 cursor-pointer transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg">
          ...
          <div className="col-span-2 flex items-center gap-1.5 px-6 py-2 whitespace-nowrap bg-black rounded-3xl justify-center md:col-span-1 md:px-8 md:py-2.5 cursor-pointer transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg">
